<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\article\edit.html";i:1575334710;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1575552661;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
<!--header 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<article class="page-container">
    ...
    <form action="<?php echo url('Article/edit'); ?>" method="POST" class="form form-horizontal" id="form-article-add">
        <?php foreach($data as $k=>$v): ?>
        <input type="hidden" name="id" value="<?php echo $v['id']; ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $v['title']; ?>" placeholder="" id="" name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">文章作者：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $v['author']; ?>" placeholder="" id="" name="author">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">文章内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:600px;"><?php echo $v['content']; ?></script>
            </div>
        </div>
        <?php endforeach; ?>
        <div class="row cl">
