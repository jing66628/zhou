<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\product\edit.html";i:1575334703;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1575552661;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
<!--header 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<div class="page-container">
    <form action="<?php echo url('Product/edit'); ?>" method="post" class="form form-horizontal" id="form-article-add">
        <?php foreach($data as $k=>$v): ?>
        <input type="hidden" name="id" value="<?php echo $v['id']; ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $v['product_name']; ?>" placeholder="" id="" name="product_name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="product_price" id="" placeholder="" value="<?php echo $v['product_price']; ?>" class="input-text" style="width:90%"> 元
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="product_describe" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"><?php echo $v['product_describe']; ?></textarea>
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">原产品图：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <img src="<?php echo $v['product_url']; ?>" alt="<?php echo $v['product_name']; ?>" width="300px">
            </div>
        </div>
        <?php endforeach; ?>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品图更换：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-list-container">
                    <div class="queueList">
                        <div id="dndArea" class="placeholder">
                            <div id="filePicker-2"></div>
                            <p>或将照片拖到这里，只能上传一张大小为350px*250px的图片</p>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        function layer_close() {
            layer.confirm('确定要取消吗？', function() {
                window.location.href = "<?php echo url('Product/lst'); ?>";
            });
        }
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: "<?php echo url('Product/add_uploads'); ?>",
