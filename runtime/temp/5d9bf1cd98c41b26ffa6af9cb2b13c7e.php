<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\admin\edit.html";i:1575438610;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1575552661;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<article class="cl pd-20">
    <form action="<?php echo url('Admin/edit'); ?>" method="post" class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" autocomplete="off" value="" placeholder="如不修改密码。请放空" id="password" name="admin_pass">
            </div>
        </div>
        <div class="row cl">
