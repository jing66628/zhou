<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\login\login.html";i:1575555919;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
            ...
            <form class="form form-horizontal" action="<?php echo url('Login/login'); ?>" method="post">
                ...
                <div class="row cl">
                    <div class="formControls col-xs-8 col-xs-offset-3">
                        <input class="input-text size-L" type="text" name="admin_cap" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:150px;">
                        <img id="changeCa" src="<?php echo url('Login/captcha'); ?>"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
                </div>
                <div class="row cl">
                    <div class="formControls col-xs-8 col-xs-offset-3">
                        <label for="online">
