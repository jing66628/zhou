<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\permission\add.html";i:1574992327;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1574989519;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
<!--_meta 作为公共模版分离出去-->
    ...
    <aside class="Hui-aside">
        ...
        <div class="menu_dropdown bk_2">
            <dl id="menu-article">
                ...
                <dd>
                    <ul>
                        <li><a href="<?php echo url('Article/lst'); ?>" title="资讯管理">资讯管理</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-product">
            ...
            <dl id="menu-admin">
                ...
                <dd>
                    <ul>
                        ...
                        <li><a href="<?php echo url('Permission/lst'); ?>" title="权限管理">权限管理</a></li>
...
<section class="Hui-article-box">
    ...
    <article class="cl pd-20">
        <form action="<?php echo url('add'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-5">
                    <input type="text" class="input-text" value="admin" placeholder="" id="auth_m" name="auth_m">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-5">
                    <input type="text" class="input-text" value="" placeholder="" id="auth_f" name="auth_f">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>排序：</label>
                <div class="formControls col-xs-8 col-sm-5">
                    <input type="text" class="input-text" autocomplete="off" placeholder="排序" id="orders" name="orders" value="0">
                </div>
            </div>
            <div class="row cl">
