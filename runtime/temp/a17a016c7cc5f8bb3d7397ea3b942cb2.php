<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\role\add.html";i:1575523964;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1575552661;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
...
<article class="cl pd-20">
    <form action="<?php echo url('Role/add'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input level="<?php echo substr_count($v['ids_path'],','); ?>" type="checkbox" value="<?php echo $v['id']; ?>" name="auth_ids[]" class="valid"> <?php echo $v['auth_name']; ?><br/> <?php endforeach; ?>
            </div>
        </div>
