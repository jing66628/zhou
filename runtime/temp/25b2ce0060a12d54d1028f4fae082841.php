<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\public/../application/admin\view\product\lst.html";i:1575369752;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\header.html";i:1575552661;s:80:"D:\phpStudy\PHPTutorial\WWW\zhouzhuang\application\admin\view\layout\footer.html";i:1574939202;}*/ ?>
﻿<!--_header 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 门票管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
            title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="Hui-article">
        <div>
            <div class="pd-20">
                <form action="<?php echo url('Product/lst'); ?>" method="GET">
                    <div class="text-c"> 日期范围：
                        ...
                        <input type="text" name="product_name" id="" value="<?php echo \think\Request::instance()->get('product_name'); ?>" id="" placeholder=" 产品名称" style="width:250px" class="input-text">
                        <button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜产品</button>
                    </div>
                </form>
                <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" href="<?php echo url('Product/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span> </div>
                <div class="mt-20">
                    <table class="table table-border table-bordered table-bg table-hover table-sort">
                        ...
                        <tbody>
                            ...
                            <tr class="text-c va-m">
                                <td><?php echo $v['id']; ?></td>
                                <td><img title="<?php echo $v['product_name']; ?>" src="<?php echo $v['product_url']; ?>" width="200px"></td>
                                <td><?php echo $v['product_name']; ?></td>
                                <td><?php echo $v['product_describe']; ?></td>
                                <td><span class="price"><?php echo $v['product_price']; ?></span> 元/张</td>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a style="text-decoration:none" class="ml-5" href="<?php echo url('Product/edit',['id'=>$v['id']]); ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
<script type="text/javascript">
    ...
    function article_start(obj, id) {
        layer.confirm('确认要发布吗？', function(index) {
            $.ajax({
                type: 'post',
                url: "<?php echo url('Product/start'); ?>",
                data: {
                    "id": id
                },
                dataType: "json",
